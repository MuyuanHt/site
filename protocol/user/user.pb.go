...
func (x *ChangeUserReq) GetUserData() *UserData {
	if x != nil {
		return x.UserData
	}
	return nil
...
func (x *ChangeUserResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangeUserResp) ProtoMessage() {}

func (x *ChangeUserResp) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_user_user_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangeUserResp.ProtoReflect.Descriptor instead.
func (*ChangeUserResp) Descriptor() ([]byte, []int) {
	return file_protocol_user_user_proto_rawDescGZIP(), []int{9}
}

func (x *ChangeUserResp) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ChangeUserResp) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ChangeUserResp) GetUserData() *UserData {
	if x != nil {
		return x.UserData
	}
	return nil
...
var file_protocol_user_user_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3b, 0x0a, 0x0d, 0x43, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x2a, 0x0a, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x52, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x22, 0x6a, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x2a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x44,
	...
	,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f,
...
var file_protocol_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protocol_user_user_proto_goTypes = []interface{}{
	...
	(*ChangeUserReq)(nil),   // 8: user.ChangeUserReq
	(*ChangeUserResp)(nil),  // 9: user.ChangeUserResp
}
var file_protocol_user_user_proto_depIdxs = []int32{
	...
	0, // 3: user.ChangeUserReq.userData:type_name -> user.UserData
	0, // 4: user.ChangeUserResp.userData:type_name -> user.UserData
	1, // 5: user.UserService.FindOneUser:input_type -> user.FindOneUserReq
	4, // 6: user.UserService.FindAccount:input_type -> user.FindAccountReq
	6, // 7: user.UserService.CreateUser:input_type -> user.CreateUserReq
	2, // 8: user.UserService.FindOneUser:output_type -> user.FindOneUserResp
	5, // 9: user.UserService.FindAccount:output_type -> user.FindAccountResp
